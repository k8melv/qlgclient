...
function checkoutModal(){
    ...
    if (cart === null || cart === "null"){
        ...
        html += `<div id="cc" class="col-md-6"><label for="ccn" class="labels">Credit Card Number:</label><input id="ccn" type="number" class="form-control" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx"></div>`
        html += `<div id="expDate" class="col-md-6"><label class="labels">Expiration Date:</label><input type="date" class="form-control" placeholder=""></div>`
        html += `<div id="cvv" class="col-md-6"><label class="labels">CVV:</label><input type="number" inputmode="numeric" class="form-control" maxlength="4" placeholder="----"></div>`
