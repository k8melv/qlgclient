...
function displayAddMenu(){
  ...
  html += `</div><div class="modal-body"><div>Garden Picture: <input class='input' type="file" value="Choose File" id="gpic" accept='image/jpeg'></div><div>Garden Type: <input class='input' type="edit" placeholder="Enter Type" id="gtype"></div><div>Garden Information: <input class='input' type="edit" placeholder="Enter Information" id="ginfo"></div>`;
