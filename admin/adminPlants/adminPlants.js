...
function displayModal(data){
    ...
    html += `</div><div class="modal-body"><img class="modalImg" src="./assets/plant-${data[0].plantID}.jpeg" alt="Picture" width="300" height="200"/><div style="font-weight: 650">Location: <input type="edit" value="${data[0].location}" id="editLocation"></div><div style="font-weight: 650">Water Needs: <input type="edit" value="${data[0].numTimesWater}" id="editWater"></div><div style="font-weight: 650">Sun Needs: <input type="edit" value="${data[0].sunNeeds}" id="editSun"></div><div id="plantinfo" style="font-weight: 650">Plant Information: <input type="edit" value="${data[0].information}"id="editInfo"></div><div style="font-weight: 650">Fun Fact: <input class="form-control" type="edit" value="${data[0].funFact}" id="editFact"></div>`;
